const TRANSITION_FEES: Record<string, bigint> = {
    ...
    commit_bid_usdcx: BigInt(1_400_000),
    commit_bid_usad: BigInt(1_400_000),
    finalize_auction: BigInt(1_300_000),
    cancel_auction: BigInt(800_000),
    slash_unrevealed: BigInt(900_000),
    slash_unrevealed_usdcx: BigInt(1_100_000),
    slash_unrevealed_usad: BigInt(1_100_000),
    refund_stake: BigInt(900_000),
    refund_stake_usdcx: BigInt(1_100_000),
    refund_stake_usad: BigInt(1_100_000),
    accept_price: BigInt(1_200_000),
    commit_accept: BigInt(1_200_000),
    commit_accept_usdcx: BigInt(1_400_000),
    commit_accept_usad: BigInt(1_400_000),
    confirm_accept: BigInt(1_200_000),
    expire_auction: BigInt(800_000),
    refund_commit_stake: BigInt(800_000),
    refund_commit_stake_usdcx: BigInt(1_000_000),
    refund_commit_stake_usad: BigInt(1_000_000),
};
