    ...
    return (
        <PageShell className="space-y-6">
            <PageHeader
                ...
                description={`Track the live price, take it in one transaction, then import the result into the linked RFQ. Pricing and settlement use ${tokenLabel(auctionTokenType)}.`}
