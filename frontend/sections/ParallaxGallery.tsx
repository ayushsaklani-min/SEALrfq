...
import { ArrowRight, Building2, Landmark, Truck, Palette, Package } from 'lucide-react';
import { parallaxGalleryConfig } from '@/config';

gsap.registerPlugin(ScrollTrigger);

const ICONS = [Building2, Landmark, Truck, Palette, Package, Building2];
    ...
    >
      ...
      >
        ...
        <div className="px-12 mb-12">
          ...
          <h2 className="font-display text-4xl md:text-5xl text-[#F4F6FA]">
            {parallaxGalleryConfig.sectionTitle}
          </h2>
        </div>
        ...
        >
          {parallaxGalleryConfig.parallaxImagesTop.map((image) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#07070B]/50 to-transparent" />
            </div>
          ))}
        </div>
      ...
      {/* Marquee Section */}
      <div className="relative py-8 bg-[#0F0F14] overflow-hidden border-y border-white/5">
        <div className="animate-marquee flex whitespace-nowrap">
          {[...Array(8)].map((_, i) => (
            ...
            >
              ...
              <span className="text-[#39F2AE]/40">●</span>
            </span>
          ))}
        </div>
      </div>
      ...
      >
        ...
        >
            ...
            return (
              ...
              >
                <div className="relative w-[450px] h-[300px] overflow-hidden rounded-xl">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#07070B]/80 via-transparent to-transparent" />

                  {/* Category pill */}
                  <div className="absolute top-4 left-4 flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#39F2AE]/20 border border-[#39F2AE]/30">
                    <IconComponent className="w-3.5 h-3.5 text-[#39F2AE]" />
                  ...
                  <div className="absolute bottom-6 left-6">
                    <h3 className="font-display text-2xl text-[#F4F6FA]">
                      {image.title}
                    </h3>
                  </div>

                  {/* Hover overlay */}
                  <div className="absolute inset-0 bg-[#39F2AE]/0 group-hover:bg-[#39F2AE]/10 transition-colors duration-300" />
                </div>
          ...
          <div className="flex-shrink-0 flex flex-col items-center justify-center w-[300px] h-[300px]">
            <button
              ...
              className="group flex flex-col items-center gap-4 text-[#F4F6FA] hover:text-[#39F2AE] transition-colors"
            >
              <div className="w-20 h-20 rounded-full border border-white/20 group-hover:border-[#39F2AE] flex items-center justify-center transition-colors">
        ...
        <div className="absolute bottom-[4vh] right-[4vw] z-20">
          <span className="font-mono-custom text-xs text-[#A7ACB8]/60 uppercase tracking-wider">
            Scroll
          </span>
        </div>
